...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return Promise.all([
      ...
      queryInterface.addColumn('Orders', 'isClientDidGetInTouch', {
        type: DataTypes.BOOLEAN, allowNull: false, defaultValue: false
      }),
      queryInterface.addColumn('Orders', 'clientDidGetInTouchAt', {
  ...
  down: (queryInterface, Sequelize) => {
    return Promise.all([
      queryInterface.removeColumn('Orders', 'isClientDidGetInTouch'),
      queryInterface.removeColumn('Orders', 'clientDidGetInTouchAt'),
