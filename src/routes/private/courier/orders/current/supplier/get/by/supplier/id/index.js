...
// {
//   "supplierId": "required: <number> Ref. OrderSupplier.id"
// }
...
// /private/courier/orders/current/supplier/get/by/supplier/id/:id
...
module.exports = function(App, RPath){
  ...
  router.use('', async(req, res)=>{
    ...
    try{
      ...
      const supplierId = req.getCommonDataInt('id', null);
      if( !App.isPosNumber(supplierId) )
        return App.json( res, 417, App.t(['order','supplier','id','is-required'], req.lang) );

      if( !(await App.getModel('OrderSupplier').isset({ id: supplierId, orderId: mCourier.activeOrderId })) )
        return App.json( res, 417, App.t(['order','supplier','not-found','or/and','do','not','belong','to','your','current','order'], req.lang));
