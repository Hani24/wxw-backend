...
// /private/admin/discount-codes/update/by/id/:id
module.exports = function(App, RPath){
  ...
  router.use('', async(req, res)=>{
    ...
    try{
      ...
      const updateDiscountCode = await mDiscountCode.update(discount_t);
      if( !App.isObject(updateDiscountCode) || !App.isPosNumber(updateDiscountCode.id) )
        return App.json( res, false, App.t(['Failed to update Discount code'], req.lang) );

      App.json( res, true, App.t('success', res.lang), updateDiscountCode);
