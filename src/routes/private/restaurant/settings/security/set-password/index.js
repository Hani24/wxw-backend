...
module.exports = function(App, RPath){
  ...
  router.use('', async(req, res)=>{
    ...
    try{
      ...
      const mUser = await req.user; // admin/restaurant/manager/employee
      ...
      if( mUser.role === roles.admin ){
        const changePasswordEmailRes = await App.Mailer.send({
          ...
          data: await App.Mailer.createEmailTemplate('restaurant-password-has-been-changed', { 
            lang: 'en',
        ...
        if( !changePasswordEmailRes.success ){
          console.error(`changePasswordEmailRes: ${changePasswordEmailRes.message}`);
