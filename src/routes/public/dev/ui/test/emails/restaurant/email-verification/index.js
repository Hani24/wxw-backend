...
module.exports = function(App, RPath){
  ...
  router.use('', async(req, res)=>{
    ...
    try{
      ...
      App.html(res, await App.Mailer.createEmailTemplate('restaurant-email-verification', { 
        lang: 'en',
        code: /*mAccessRecovery.*/code,
        path: App.toAppPath( 'web', 'restaurant.email-verification-verify', /*mAccessRecovery.*/code, false),
      }));
